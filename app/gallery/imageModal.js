    ...
    <div>
      ...
      <div className="flex flex-wrap justify-center gap-y-5">
        {images.map((imgSrc, index) => (
          <div key={index} className="w-[100%] md:w-[49%] lg:w-[31%] px-2">
            <img
      ...
      {isOpen && (
        <div
          ...
          onClick={closeImage} // Close modal on background click
            ...
            >
              {images.map((imgSrc, idx) => (
                <img
                  ...
                  style={{
                    scrollSnapAlign: 'center', // Centers the image in the viewport when scrolled
                    flex: '0 0 auto', // Prevents images from shrinking or wrapping
                  }}
                />
              ))}
            </div>
